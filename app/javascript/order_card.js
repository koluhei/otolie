const pay = () => {
  ...
  submit.addEventListener("click", (e) => {
    ...
    const card = {
      number: formData.get("order_request[number]"), 
      exp_month: formData.get("order_request[exp_month]"),
      exp_year: `20${formData.get("order_request[exp_year]")}`,
      cvc: formData.get("order_request[cvc]"),
    };
